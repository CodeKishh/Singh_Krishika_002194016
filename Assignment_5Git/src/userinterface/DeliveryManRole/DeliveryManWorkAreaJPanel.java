...
public class DeliveryManWorkAreaJPanel extends javax.swing.JPanel {
    ...
    public void populateTable(){
        ...
        for(DeliveryMan deliveryMan : business.getDeliveryManDirectory().getdMD()){
            if(deliveryMan.getDeliveryUserName().equals(userAccount.getUsername())){
                ...
                row[3] = order.getDeliveryLocation();
                row[4] = order.getCost();
    ...
    private void initComponents() {
        ...
        lblOrderD = new javax.swing.JLabel();
        ...
        add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 80, 640, 90));
        ...
        add(refreshJButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 210, 90, -1));
        ...
        add(processJButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 210, 170, -1));

        lblOrderD.setText("Order Detail");
        add(lblOrderD, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 20, -1, -1));
    ...
    private javax.swing.JLabel lblOrderD;
